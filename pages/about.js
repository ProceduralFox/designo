    ...
    <>
        ...
        <main className="container">
            <section className={styles.top}>
                ...
                <img loading="eager" src={screenW < 1112 ? screenW < 600 ? "./AboutUs/Top-M.jpg" : "./AboutUs/Top-T.jpg" : "./AboutUs/Top-D.jpg"} alt="" />
            </section>

            <section className={styles.mid}>
                <img src={screenW < 1112 ? screenW < 600 ? "./AboutUs/Mid-M.jpg" : "./AboutUs/Mid-T.jpg" : "./AboutUs/Mid-D.jpg"} alt="" />
                <div className="">
            ...
            <section className={styles.bottom}>
                    ...
                    <img src={screenW < 1112 ? screenW < 600 ? "./AboutUs/Bottom-M.jpg" : "./AboutUs/Bottom-T.jpg" : "./AboutUs/Bottom-D.jpg"} alt="" />
            </section>
        </main>
    </> );
}
